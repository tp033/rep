...
{
    public partial class ViewAllBooking : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Select")
            {
               ...
               bID.Text = GridView1.DataKeys[Convert.ToInt32(e.CommandArgument)].Values["BookingId"].ToString();
                lblSelectedAgent.Text = GridView1.DataKeys[Convert.ToInt32(e.CommandArgument)].Values["agentUsername"].ToString();
            }
        }
    }
}